...
class rain_drop:
    ...
    def draw_drop(self):
        color = [255,0,255]
        return pygame.draw.line(simulation_window,
                                color,
                                self.position_x,
                                [self.position_x[0],self.position_x[1] + self.height],self.width)
...
def setup():
    ...
    game_rain_drops = [ rain_drop([random.randint(0,sim_window_width),
                              random.randint(-sim_window_height,0)],
                             random.randint(0,7),random.randint(0,4)) for rain_drop in range(10000)]
